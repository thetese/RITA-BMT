...
export const vsdcApi = {
  ...
  /**
   * Mocks POST /saveStockItems/saveStockItems
   * Page 52 of VSDC Specification Document
   */
  async saveStockItems(requestBody) {
    console.log("Mock VSDC received stock movement:", requestBody);
    ...
    console.log("Mock VSDC returning stock response:", mockResponse);
    return mockResponse;
  }
};
